...
After the file is write, encode by the following command. Here,  `your_path_of_ecdag_encode_config` is your file path to the config file of encode operations, see `[your_path]/conf/640_n_14_k_10/ecdag_encode_640_0` for example.
